    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map(leader .. 'r', require('telescope.builtin').lsp_references, '[R]eferences')

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          map(leader .. 'i', require('telescope.builtin').lsp_implementations, '[I]mplementation')

          -- Jump to the definition of the word under your cursor.
          --  This is where a variable was first declared, or where a function is defined, etc.
          --  To jump back, press <C-t>.
          map(leader .. 'd', require('telescope.builtin').lsp_definitions, '[D]efinition')
          ...
          map(leader .. 's', require('telescope.builtin').lsp_document_symbols, 'Open Document [S]ymbols')

          -- Fuzzy find all the symbols in your current workspace.
          --  Similar to document symbols, except searches over your entire project.
          map(leader .. 'S', require('telescope.builtin').lsp_dynamic_workspace_symbols, 'Open Workspace [S]ymbols')
